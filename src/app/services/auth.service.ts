...
export class AuthService {
  ...
  signup(email: string, password: string) {
    ...
    return this.http
      .post<AuthResponseData>(
        'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDwZhpJ1HXBKJzN-P-SGptC8ssQxVAh010',
        {
          email: email,
          password: password,
  ...
  login(email: string, password: string) {
    return this.http
      .post<AuthResponseData>(
        'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDwZhpJ1HXBKJzN-P-SGptC8ssQxVAh010',
        {
          email: email,
          password: password,
          returnSecureToken: true,
